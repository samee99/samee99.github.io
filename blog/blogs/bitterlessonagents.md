...
As models get better using test time compute the hyperparameter optimization load on the generation step. Some of the search would have already been done at test time by models like o1. This also means that the search space over which the hyperparameters. 
