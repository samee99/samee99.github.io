...
Why is this important? Well, every step can be a single point of failure and increasing the reliability of each step ensures that we traverse down the right path to get to the goal instead of rolling in the right slope. 
