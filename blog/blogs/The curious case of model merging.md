...
- SLERP stands for Spherical Linear Interpolation. It's a way to find the path between two points on a hypersphere, remember hypersp. Imagine you are traveling from New York to Paris. SLERP would give you the shortest flight path from New York to Paris. 
