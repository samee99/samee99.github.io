...
Notice that Neo depended on AutoML capability to optimize the retriever and generation tool. To handle more usecases, Neo needs to be able to identify each additional tool it requires and build a mechanism to optimize that tool. 
