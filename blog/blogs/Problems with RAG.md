...
So why is this hard? Let's imagine you want to build a production grade RAG pipeline. You need to first build a data parsing and ingestion system. Then you have to embed your parsed data. 
